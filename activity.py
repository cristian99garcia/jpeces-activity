...
path = os.path.join(get_bundle_path(), lib)
os.environ['LD_LIBRARY_PATH'] = path
os.environ["LD_PRELOAD"] = os.path.join(path, "libsugarize.so")
os.environ["LD_LIBRARY_PATH"] = os.path.join(path, "libsugarize.so")
